        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                for (int px = 0; px < width; px++) {
                    double x = xMin + (px / (width / (xMax - xMin)));
                    double y = f(x);
                ...
                java.util.function.Function<Double, Integer> mapY = y -> (int) (height - (y - finalYMin) * yScale);
                ...
                int stepY = (int) Math.max(1, (yMax - yMin) / 20); 
                for (int y = (int) (Math.ceil(yMin / stepY) * stepY); y <= yMax; y += stepY) {
